...
public class JsonUtilTest {
    ...
    public void testFormatJson() throws Exception {
        final String expectedJson = "{\"chest_ecg\":{\"initial_timestamp\":0,\"data\":[10,11,12,13,14],\"delta\":[5,5,5,5]},\"chest_ppg\":{\"initial_timestamp\":0,\"data\":[100,101,102,103,104],\"delta\":[6,6,6,6]},\"chest_inertia_x\":{\"initial_timestamp\":0,\"data\":[1000,1001,1002,1003,1004],\"delta\":[7,7,7,7]}}";
        ...
        assertThat(JsonUtil.formatJson(data).toString(0), equalTo(expectedJson));
    }

    @Test
    public void testFormatJson_NoData() throws Exception {
        assertThat(JsonUtil.formatJson(new ArrayList<RawDataPoint>()).toString(0), equalTo("{}"));
    }
}